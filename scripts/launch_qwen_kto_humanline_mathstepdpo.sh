...
CKPT=/data/niklas/models/qwen-32b-kto-humanline-mathstepdpo
...
accelerate launch \
    ...
    --max_restarts 0 \
    launch.py loss=kto model=qwen train_datasets=[mathstepdpo] test_datasets=[mathstepdpo] exp_name=qwen-32b-kto-humanline-mathstepdpo do_first_eval=false \
    ...
    ++model.attn_implementation=flash_attention_2 ++eval_every=999999 ++humanline=true
