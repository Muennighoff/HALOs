...
CKPT=/data/niklas/models/qwen-32b-kto-humanline-v2
...
accelerate launch \
    ...
    --max_restarts 0 \
    launch.py loss=kto model=qwen train_datasets=[s1k_11] test_datasets=[s1k_11] exp_name=qwen-32b-kto-humanline-v2 do_first_eval=false \
