...
CKPT=/data/niklas/models/qwen-32b-sft-1404
...
accelerate launch \
    ...
    --max_restarts 0 \
    launch.py loss=sft model=qwen train_datasets=[s1k_11] test_datasets=[s1k_11] exp_name=qwen-32b-sft-1404 do_first_eval=false \
    ...
    ++model.attn_implementation=flash_attention_2 ++eval_every=999999 ++n_epochs=5
