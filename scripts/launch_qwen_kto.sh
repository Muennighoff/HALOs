...
CKPT=/data/niklas/models/qwen-32b-kto-v2
...
accelerate launch \
    ...
    --max_restarts 0 \
    launch.py loss=kto model=qwen train_datasets=[s1k_11] test_datasets=[s1k_11] exp_name=qwen-32B-kto-v2 do_first_eval=false \
...
python -m train.sample $CKPT --gpu_count 2 --output_file outputs/qwen-32b-kto-v2.json
"